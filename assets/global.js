...
let imageBanner = document.querySelector(
  "#Banner-template--14753463730210__image_banner"
);
...
let mediaQueryMobile = window.matchMedia("(max-width: 750px)");
resizeHeaderHeight(mediaQueryMobile);
mediaQueryMobile.addListener(resizeHeaderHeight);
